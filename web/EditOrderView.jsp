...
<%@page import="com.oc.helpclases.HelperClass"%>
<%@page import="com.oc.model.OrderMaster"%>
<%@page import="java.util.List"%>
<%@page import="com.oc.dao.daoclases.OrdermasterImpl"%>
            ...
            <form style="width: 100%;" class="center-block form-horizontal" action="EditOrderServlet" method="post"  id="formulario">
                ...
                <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="hidden" id="hiddenproviderId" value="${orderMaster.contact.provider.providerid}">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="hidden" id="hiddensellerId" value="${orderMaster.seller.sellerid}">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-md-8">
                                 <input type="hidden" id="hiddencontactId" value="${orderMaster.contact.id.contactid}">
                                 <input type="hidden" id="hiddencontactname" value="${orderMaster.contact.contactname}">                            
                                <jsp:include page="HelperPages/ContactDropDown.jsp"></jsp:include>
                             </div>
                        </div>
                         <div class="form-group">
                             <div class="col-md-4">
                        ...
                        <table class="table table-striped table-hover table-condensed" >
                            ...
                            <c:forEach var="orderDetail" items="${orderMaster.orderDetails}">
                                <tr id="${orderDetail.id.orderdetailid}" >
                                    ...
                                    <input type="hidden" id="hiddenproductid" value="${orderDetail.product.productid}">
                                    <td><jsp:include page="HelperPages/ProductDataList.jsp"></jsp:include></td>
                                    <td><input type="text" value="${orderDetail.product.productname}" class="form-control input-sm" readonly id="nameProduct"></td>
...
//        productIdTex.on("blur",productName); 
    ...
    function asignarValores(){
        ...
        var hiddenContactId = document.getElementById("hiddencontactId");
        ...
        var selectContactId = document.getElementById("contactid");
        ...
        optionElement.value= hiddenContactId.value;
        optionElement.label = hiddenContactName.value;
        optionElement.selected = true;
        
        selectContactId.appendChild(optionElement);
