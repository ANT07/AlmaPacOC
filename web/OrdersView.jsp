...
<%@page import="com.oc.model.OrderDetail"%>
...
<html>
    ...
    <body>
        ...
        <%
            List<OrderMaster> ordersMastersBusqueda = (List<OrderMaster>) request.getAttribute("orders");
                        ...
                        <%for (OrderMaster ordersMaster : ordersMasters) {%>
                               <tr>
                                   <td><%= formato.format(ordersMaster.getOrderdate()) %></td>
                                    ...
                                    <td><%= ordersMaster.getSeller().getSellername() %></td>
                                            ...
                                            <table class="table table-condensed table-hover table-striped">
                                                ...
                                                <%for (OrderDetail orderDetail : details) {%>
                                                    <tr>
                                                        ...
                                                        <td style="font-size: 9pt;"><%=orderDetail.getProduct().getProductid() %></td>
                                                        <td style="font-size: 9pt;"><%=orderDetail.getProduct().getProductname() %></td>
...
//    
    function redirigirReporte(id){
        ...
        window.open("ViewReport.jsp?orderId=" + id,"Orden de Compra No.:" + id);
    }
</script>
