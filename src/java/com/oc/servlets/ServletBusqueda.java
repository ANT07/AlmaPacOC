...
public class ServletBusqueda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>");
            out.println(
                    "<h1>Servlet ServletBusqueda at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request,
        ...
        OrderMaster orderMasterExample = new OrderMaster();
        orderMasterExample.setOrderid(orderId);
        
        OrdermasterImpl orderMasterImpl = new OrdermasterImpl();
        
        List<OrderMaster> orders = orderMasterImpl.busquedaOrdenes(
                orderMasterExample);
        
        request.setAttribute("orders",
                orders);
        
        request.getRequestDispatcher("/OrdersView.jsp").forward(request,
                response);
    }
